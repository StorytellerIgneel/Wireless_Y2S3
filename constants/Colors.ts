...
const text_secondary = 'rgba(88, 88, 88, 1)';
...
const btn_bg_primary_inactive = 'rgb(255, 243, 214)';
...
const btn_bg_danger = 'rgb(245, 66, 66)';
const btn_bg_danger_inactive = 'rgb(255, 152, 152)';

const bg_primary = 'rgba(255, 255, 255, 1)';
const bg_secondary = 'rgba(246, 248, 250, 1)';

// Dark
const dark_text_primary = 'rgba(255, 255, 255, 1)';
const dark_text_secondary = 'rgba(255, 255, 255, 0.8)';
...
export const Colors = {
  light: {
    ...
    btn_danger: dark_text_primary,
    btn_bg_danger: btn_bg_danger,
    btn_bg_danger_inactive: btn_bg_danger_inactive,
    // tabIconDefault: '#687076',
    // tabIconSelected: tintColorLight,
    invert_text: dark_text_primary,
  },
  dark: {
